...
Figure 2 shows the overall numbers of accidents from 2014 to 2018. It appeared that the roads in Leeds had been becoming safer, with steady declines in the numbers of accidents since 2015. 2018 saw 25% less accidents than 2015. A breakdown by severity of accidents, shown in Figure 3, revealed further insights. The decline in overall accident numbers since 2015 was largely contributed by decreases in slight and serious accidents. Fatal accidents, however, had been on a rise since 2016.

# 3. The 'Who': Profile of Accident Casualties

Having pre-processed the data and performed EDA, we will begin our analysis to obtain insights on accidents involving pedestrians and cyclists. The first aspect of the analysis is to answer the question, "Who were most at risk of accidents?". This will be done by understanding the profiles of pedestrian and cyclist casualties based on past data. 

## 3.1 Methodology

Limited demographic information about accident victims were available in the dataset, presumably due to privacy reasons. In this section, histograms and boxplots were used to visualise the number of casualties by age and gender, which were the only demographic information available in the dataset. Histograms provide useful insights into the distributions of casualties by age and gender, whereas boxplots allow us to graphically visualise the median and spread of the age of casualties. 
...
Given the analyses and findings in this report, we propose a three-pronged strategy in enhancing road safety for pedestrians and cyclists---engineering, engagement and enforcement. This section outlines the key policy recommendations under each category.

## 8.1 Engineering the Roads for Better Safety

Road engineering is one key element of road safety. We saw from our analyses in Section 6 that Leeds city centre had high numbers of pedestrian and cyclist accidents, but a majority of them had slight injuries. To reduce such accidents, the local authorities can consider introducing more non-signalised crossings such as zebra crossings. They provide more options for the crossing of roads so that pedestrians do not have to jay-walk. Barriers can be errected between pavements and roads to deter jay-walking and nudge people to use legitimate crossings. 

For cyclists, more of the existing cycling lanes in the city centre can be segregated from vehicular lanes with kerbs, similar to the 2.5 mile-long stretch of cycling lane in the city centre that was opened in July 2019 as part of the Bradford-Leeds Cycle Superhighway (cite1). In addition, along stretches with high propensity of cyclist accidents as we saw in Section 6, the existing cycling infrastructures can be further improved. Possible areas of improvement include repainting faded lanes, lane-widening and installing kerb to segregate them from the main traffic.  

## 8.2 Engagement for Better Road Safety Awareness

Road safety engagement is another key pillar in improving safety of pedestrians and cyclists. Such engagement should be targeted to address the safety of specific groups. For instance, in Section 6, we saw that Harehills Lane was the only road in the top 5 lists that does not lead to the city centre but yet recorded high pedestrian accidents. Local authorities can engage residents living in its vicinity on ways to improve their safety on the roads. Given that there are also at least five primary schools near Harehills Lane, it will also be useful to give road safety talks to children of these schools. This is especially important because, as we saw in Section 4, children between 12 to 14 years old were particularly prone to accidents. Other possible target groups for road safety engagement include the sports cycling community, cycling groups at tertiary institutions as well as the senior citizen population.  

## 8.3 Enforcement to Shape Road Users' Behaviours

Effective traffic enforcement is essential in ensuring that road users comply with traffic rules to make the roads a safer place for everyone. Roads are a shared environment and one's careless or reckless behaviour can potentially impact another's life. Pedestrians and cyclists are typically victims in accidents with motor vehicles. They were also most prone to accidents on weekday evenings and weekday mornings respectively, as we saw in Section 5. Therefore, projecting police presence to enforce traffic rules during these timings at accident-prone areas would shape drivers' behaviours towards safer driving, thereby reducing the chances of accidents with these vulnerable road users. 

Local authorities can consider installing more speed cameras along stretches with high numbers of speed-related accidents to detect speeding. In addition, local authorities can explore using technology to automatically detect other traffic offences such as dangerous lane-changing and illegal turns. Pedestrians and cyclists themselves also have a responsibility towards ensuring their own safety. Enforcement of rules against pedestrians and cyclists, such as reckless cycling, riding without helmets and jay-walking, will also send a stern message to these road users. 
