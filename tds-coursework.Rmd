...
```{r display_figure_7, eval=TRUE, echo=FALSE, include=TRUE, fig.cap="Top 5 roads with highest accident counts for pedestrians and cyclists", out.width="55%"}
...
Pedestrians and cyclists are especially vulnerable to serious or even fatal injuries in accidents. Moreover, @InvestigatingRatesImpacts2015 found that experiencing or witnessing near-misses such as dangerous passing manoeuvres by larger vehicles contributes to the perception of risks and prevents people from adopting cycling. Therefore, any efforts to address their safety on the roads will not only help save lives but also alleviate fears and encourage uptake. Such endeavours are also aligned with the national goal to increase cycling and walking rates. This report has been one such endeavour towards safer roads and an uptake of walking and cycling in Leeds. 
