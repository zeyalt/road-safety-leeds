...
```{r display_figure_1, eval=TRUE, echo=FALSE, include=TRUE, fig.cap="Trends in number of road accident casualties in Leeds, 2014-2018", fig.subcap=c("Casualties by year", "Casualties by year and accident severity"), out.width="47.5%"}
...
```{r display_figure_7, eval=TRUE, echo=FALSE, include=TRUE, fig.cap="Results of cross-validation", fig.subcap=c("Prediction of Pedestrian Accident Rates", "Prediction of Cyclist Accident Rates"), out.width="45%"}
...
```{r display_figure_8, eval=TRUE, echo=FALSE, include=TRUE, fig.cap="Buffer of roads around Lawnswood School (yellow) with children-related accident locations (blue)", out.width="42.5%"}
