...
In the interest of protecting data privacy, limited demographic information about accident victims was provided in the dataset. Nevertheless, using available information, we plotted histograms and boxplots to analyse the distributions of pedestrian and cycHavinglist casualties by age and gender. (why histograms and boxplots?) 
...
```{r display_figure_5, eval=TRUE, echo=FALSE, include=TRUE, fig.cap="Heatmap showing the number of pedestrian and cyclist accidents, by day and month"}
...
```{r display_figure_6, eval=TRUE, echo=FALSE, include=TRUE, fig.cap="Heatmap showing the number of pedestrian and cyclist accidents, by hour and day", out.width="60%"}
